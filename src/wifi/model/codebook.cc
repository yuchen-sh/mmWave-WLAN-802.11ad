...
double Codebook::GetMaxGainDbi (uint8_t numSector, uint8_t numAntenna)
{
  double BeamWidth = 2*PI*1.0 / (numSector * numAntenna *1.0);
  double HFPB = BeamWidth / 2.6;
  double maxGain = 10 * log10 (pow (1.6162/sin (HFPB / 2), 2));
  return maxGain;
}
