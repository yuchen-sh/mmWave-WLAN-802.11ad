...
ThreeGppHttpVariables::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::ThreeGppHttpVariables")
    ...
    .AddAttribute ("HighMtuSize",
                   ...
                   MakeUintegerAccessor (&ThreeGppHttpVariables::SetHighMtuSize),
                   MakeUintegerChecker<uint32_t> (0))
    .AddAttribute ("HighMtuProbability",
                   ...
                   MakeDoubleAccessor (&ThreeGppHttpVariables::SetHighMtuProbability),
...
void 
ThreeGppHttpVariables::SetHighMtuProbability (double prob)
{
  NS_LOG_FUNCTION (this << prob);
  m_highMtuProbability = prob;
}

void 
ThreeGppHttpVariables::SetHighMtuSize (uint32_t sizeByte)
{
  NS_LOG_FUNCTION (this << sizeByte);
  m_highMtu = sizeByte;
}
