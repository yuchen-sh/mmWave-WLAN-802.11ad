...
public:
  ...
  /**
   * \param The probability that higher MTU size is used.
   */
  void SetHighMtuProbability (double prob);
  /**
   * \param The higher MTU size.
   */
  void SetHighMtuSize (uint32_t sizeByte);
